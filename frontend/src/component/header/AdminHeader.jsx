                ...
                <Offcanvas.Body>
                    <nav 
                        ...
                        <div 
                            ...
                            <Link to={"/admin"} style={styles.main}>
                                우정카드
                            </Link>
                            ...
                            <div className="flex-column">
                                ...
                                <div>
                                    <Link to={"/admin/cardManage"} style={styles.sub}>
                                        카드상품관리
                                    </Link>
                                </div>
                            </div>
                            ...
                            <div className="flex-column">
                                <div>
                                    <Link to={"/admin/userManagement"} style={styles.main}>
                                        고객관리
                                    </Link>
                                </div>
                                <div>
                                ...
                                <div>
                                    <Link to={"/admin/userCardAppHistory"} style={styles.sub}>
                                        카드신청내역
                                    </Link>
                                </div>
                                <div>
                                    <Link to={"/admin/userCardCancelHistory"} style={styles.sub}>
                                        정지신청내역
                                    </Link>
                                </div>
                            </div>
                            ...
                            <div className="flex-column">
                                <div>
                                    <Link to={"/admin/storeManagement"} style={styles.main}>
                                        가맹점관리
                                    </Link>
                                </div>
                                <div>
                                    <Link to={"/admin/storeManagement"} style={styles.sub}>
                                        가맹점정보조회
                                    </Link>
                                </div>
                                <div>
                                    <Link to={"/admin/storeAppManagement"} style={styles.sub}>
                                        가맹점신청내역
                                    </Link>
                                </div>
                                {/* <div>
                            ...
                            <div className="flex-column">
                                ...
                                <div>
                                    <Link to={"/admin"} style={styles.sub}>
                                        통합매출관리
                                    </Link>
                                </div>
                            </div>
                            
                            <Link to={"/"} style={styles.main} onClick={onClickLogOut}>
                                로그아웃
                            </Link>
